...
GOOGLE_CALENDAR_CONNECTION_ERROR_MESSAGE = (
    'Google Calendar could not be reached. Please check your network connection and try again.'
)
GOOGLE_CALENDAR_TIMEOUT_ERROR_MESSAGE = (
